...
class Interpreter(Cmd):
    ...
    def do_display_graph(self, *args):
        ...
        ***
        OPTIONS
        -s : Shows a bar graph of the total sales made by males verse \
the total sales made by female.
        -g : Shows a pie chart of the percentage of female workers verse \
 male workers
        -a : Shows a bar graph of peoples age verse their salary.
        -b : Shows a pie chart of the BMI of a set of people.
        ***
        """
         ...
         for key, value in option_dict.items():
             if options_arr[0] == key:
                 ...
                 director.do_make_graph(self.database)
    ...
    def do_create_graph(self, args):
        ...
        """
        try:
            args = plt.getopt(args, "t:o:", ["graph-type=", "option="])
            argss = args[1].split()
    ...
    def do_list_graphs(self, args):
        ...
        """
        try:
            args = plt.getopt(args, "t:o:", ["graph-type="])
            argss = args[1].split()
